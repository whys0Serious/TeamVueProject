    ...
    <div id="showPic">
      <el-carousel :interval="4000" type="card" height="300px">
        <el-carousel-item v-for="item in pic" :key="pic.pic_num">
          <h3 class="medium">
            <img width="800px" height="300px" ref="300px":src="item.pic2"/></h3>
        </el-carousel-item>
      </el-carousel>
    </div>
    ...
    <el-row>
      ...
      <el-card shadow="hover" :body-style="{ padding: '0px' }">
        <div style="padding: 14px;">
          <div class="clearfix">
            <el-tag type="info"effect="dark">初中</el-tag>
          </div>
...
//              console.log(res.data)
      ...
      axios.get("api/findShow/sugg/2").then(res=>{
        console.log(res.data)
