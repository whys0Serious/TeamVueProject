<template>
  <div >
    ...
    <div id="lbt">
      <el-carousel height="450px">
        <el-carousel-item v-for="item in items" :key="item">
          <img style="height: 450px" :src="item.src"/>
        </el-carousel-item>
      </el-carousel>
    </div>
    ...
    <div class="fenleishow">
      <div class="xue">
        <div class="hot_top"><h3>小学</h3></div>
        <div class="classhow">
          <div class="xueimg">
      ...
      <!--初中-->
      <div class="xue">
        <div class="hot_top"><h3>初中</h3></div>
        <div class="classhow">
          <div class="xueimg">
      ...
      <!--高中-->
      <div class="xue">
        <div class="hot_top"><h3>高中</h3></div>
        <div class="classhow">
          <div class="xueimg">
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        items:[
          {src:'http://pylgiouvi.bkt.clouddn.com/%E8%BD%AE%E6%92%AD%E5%9B%BE1.png'},
