    ...
    <div id="showPic">
      <el-carousel :interval="4000" type="card" height="300px">
        <el-carousel-item v-for="item in pic" :key="pic.pic_num">
          <h3 class="medium">
            <img width="900px" height="300px" ref="300px":src="item.pic3"/></h3>
        </el-carousel-item>
      </el-carousel>
    </div>
...
//              console.log(res.data)
      ...
      axios.get("api/findShow/chinese/3").then(res=>{
        console.log(res.data)
        this.chinese=res.data;
      })
      axios.get("api/findShow/math/3").then(res=>{
        console.log(res.data)
        this.math=res.data;
      })
      axios.get("api/findShow/English/3").then(res=>{
        console.log(res.data)
